...
def parse_args():
    ...
    parser.add_argument("--input-img-dir", default="data/AerialImageDataset/train/val_images")
    parser.add_argument("--input-mask-dir", default="data/AerialImageDataset/train/val_masks")
    parser.add_argument("--output-img-dir", default="data/AerialImageDataset/train/val/images")
    parser.add_argument("--output-mask-dir", default="data/AerialImageDataset/train/val/masks")
...
if __name__ == "__main__":
    ...
    input_img_dir = "/LDFormer/data/AerialImageDataset/train/train_images"
    input_mask_dir = "/LDFormer/data/AerialImageDataset/train/train_masks"
    ...
    imgs_output_dir = "/LDFormer/data/AerialImageDataset/train/train/images"
    masks_output_dir = "/LDFormer/data/AerialImageDataset/train/train/masks"
