...
from geoseg.models.LDFormer import LDFormer
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = "model_weights/inriabuilding/builduformer/resnet50-82.67.ckpt"
# pretrained_ckpt_path = "model_weights/whubuilding/builduformer/best.ckpt"
pretrained_ckpt_path = None
resume_ckpt_path = None
#  define the network
net = LDFormer(num_classes=num_classes, decode_channels=256, num_heads=16)
# define the loss
loss = LDFormerLoss(ignore_index=ignore_index)
use_aux_loss = True
